...
// =============================================================================
export const weeklyAvailabilityTemplateBaseSchema = createInsertSchema(weeklyAvailabilityTemplates, {
...
export const weeklyAvailabilityTemplateCreateSchema = weeklyAvailabilityTemplateBaseSchema.refine(
...
export const weeklyAvailabilityTemplateUpdateSchema = weeklyAvailabilityTemplateBaseSchema.partial()
...
export const availabilityExceptionBaseSchema = createInsertSchema(availabilityExceptions, {
...
export const availabilityExceptionCreateSchema = availabilityExceptionBaseSchema.refine(
  (data) => (data.startTime && data.endTime ? data.endTime > data.startTime : true),
  {
    message: "L'heure de fin doit être après l'heure de début",
    path: ['endTime']
  }
...
export const availabilityExceptionUpdateSchema = availabilityExceptionBaseSchema.partial()
