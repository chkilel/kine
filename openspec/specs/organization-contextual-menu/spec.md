...
Defines the contextual sidebar menu displayed on organization detail pages, replacing main navigation with organization-specific links matching the patient contextual menu pattern.
