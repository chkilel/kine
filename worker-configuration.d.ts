/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a3dab46449d3f2077acccc1fdf75dae)
// Runtime types generated with workerd@1.20260426.1 2026-04-05 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		NUXT_PUBLIC_BETTER_AUTH_URL: string;
		NUXT_R2_ACCESS_KEY: string;
		NUXT_R2_SECRET_ACCESS_KEY: string;
		NUXT_R2_URL: string;
		NUXT_R2_BUCKET_NAME: string;
		NUXT_R2_ACCOUNT_ID: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV" | "NUXT_BETTER_AUTH_SECRET" | "NUXT_PUBLIC_BETTER_AUTH_URL" | "NUXT_R2_ACCESS_KEY" | "NUXT_R2_SECRET_ACCESS_KEY" | "NUXT_R2_URL" | "NUXT_R2_BUCKET_NAME" | "NUXT_R2_ACCOUNT_ID">> {}
}
