  ...
  try {
    ...
    for (const existingTemplate of existingTemplates) {
      if (
        ...
        throw createError({
          statusCode: 400,
          message: `Conflit d'horaire avec un modèle existant le ${body.dayOfWeek}. Veuillez respecter un écart minimum de ${MINIMUM_APPOINTMENT_GAP_MINUTES} minutes entre les plages horaires.`,
          data: {
            conflict: {
              existingTemplate: {
