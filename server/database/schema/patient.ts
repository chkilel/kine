...
export const patients = sqliteTable(
  'patients',
  {
    ...
    dateOfBirth: text().notNull(), // YYYY-MM-DD (date-only)
...
export const treatmentPlans = sqliteTable(
  'treatment_plans',
  {
    ...
    startDate: text().notNull(), // YYYY-MM-DD (date-only)
    endDate: text().notNull(), // YYYY-MM-DD (date-only)
    ...
    prescriptionDate: text().notNull(), // YYYY-MM-DD (date-only)
