...
<template>
  <AppDashboardPage id="settings-members" title="Membres">
    <UPageCard
      ...
      class="mb-4"
    >
      <UButton label="Inviter des personnes" color="neutral" class="w-fit lg:ms-auto" />
    </UPageCard>
    ...
    >
      <template #header>
        <UInput v-model="q" icon="i-lucide-search" placeholder="Rechercher des membres" autofocus class="w-full" />
      </template>
