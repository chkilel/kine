export default defineAppConfig({
  ui: {
    ...
    icons: {
      ...
      copyCheck: 'i-hugeicons-copy-02', // or copy-01 with validation
      ...
      hash: 'i-hugeicons-grid',
      info: 'i-hugeicons-information-circle',
      light: 'i-hugeicons-sun-01',
      loading: 'i-hugeicons-refresh',
      menu: 'i-hugeicons-menu-01',
      minus: 'i-hugeicons-remove-01',
      panelClose: 'i-hugeicons-panel-left-open',
      panelOpen: 'i-hugeicons-panel-left-close',
      plus: 'i-hugeicons-add-01',
      reload: 'i-hugeicons-rotate-clockwise',
      search: 'i-hugeicons-search-01',
      stop: 'i-hugeicons-square',
      success: 'i-hugeicons-checkmark-circle-01',
      system: 'i-hugeicons-computer',
      tip: 'i-hugeicons-idea-01',
